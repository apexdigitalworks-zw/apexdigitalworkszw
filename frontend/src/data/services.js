// Mirrors backend/config/services.js so the frontend can render instantly
// without waiting on a network call, while the live API remains the source
// of truth for checkout pricing validation.
...
export const SERVICE_CATEGORIES = [
  {
    ...
    icon: "🎨",
    description: "Eye-catching visual designs that build a memorable brand identity.",
    services: [
  ...
  },
  {
    ...
    icon: "💻",
    description: "Modern, fast, and responsive websites built to convert visitors into clients.",
    services: [
  ...
  },
  {
    ...
    icon: "📣",
    description: "Grow your audience and sales with data-driven marketing campaigns.",
    services: [
  ...
  },
  {
    ...
    icon: "📊",
    description: "Professional document, spreadsheet, and productivity support for individuals and teams.",
    services: [
  ...
  },
  {
    ...
    icon: "🌐",
    description: "Everything you need to get your business legally and digitally set up online.",
    services: [
  ...
  },
  {
    ...
    icon: "🛠️",
    description: "On-site technical installations to keep your home or business connected and secure.",
    services: [
